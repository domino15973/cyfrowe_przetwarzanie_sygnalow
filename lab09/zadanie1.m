...
t  = 0:1/fs:1;  % czas trwania
A1 = -0.5;      % amplituda
f1 = 34.2;      % częstotliwość
A2 = 1;         % amplituda
f2 = 115.5;     % częstotliwość

%% sygnał "czysty" do porównania - referencyjny
...
plot(t,dref,t,d,t,y);
title('AWGN 10dB');
legend('Sygnał "czysty"','Zaszumiony','Po odszumieniu');
